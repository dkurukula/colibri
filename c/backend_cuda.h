 ...
 * quant_matmul_tiled doc comment and tests/bench_expert_mlp_tiled.cu. */
COLI_CUDA_DLLEXPORT int coli_cuda_expert_mlp_tiled(ColiCudaTensor *gate, ColiCudaTensor *up,
                         ColiCudaTensor *down, float *y, const float *x, int S);
